<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="拼团价格" prop="price" />
      ...
      <el-table-column label="有效时间(小时)" prop="effectiveTime" />
      <el-table-column label="参团人数" prop="people" />
      <el-table-column label="限购数量" prop="quota" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="有效时间(小时)" prop="effectiveTime">
              <el-input-number v-model="formData.effectiveTime" :step="1" :min="1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="参团人数" prop="people">
              <el-input-number v-model="formData.people" :step="1" :min="1" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="限购数量" prop="quota">
              <el-input-number v-model="formData.quota" :step="1" :min="1" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import * as pinkGoods from '@/api/shop/marketing/pinkGoods.js'
import { resetData } from '@/utils'

export default {
  name: 'WxShopPinkGoods',
  ...
  methods: {
    getList() {
      ...
      pinkGoods.page(this.listQuery).then(response => {
    ...
    handleDelete(row, index) {
      this.$confirm('是否删除数据?', '提示', {
        ...
        pinkGoods.del(row.id).then(response => {
          this.$notify({
            title: '成功',
            message: '删除成功',
            type: 'success',
    ...
    saveOrUpdate() {
      ...
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          pinkGoods.saveOrUpdate(this.formData)
            .then(response => {
